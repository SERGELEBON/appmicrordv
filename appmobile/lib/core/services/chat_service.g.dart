...
class _ChatService implements ChatService {
  _ChatService(
    ...
    baseUrl ??= 'http://10.0.2.2:8083/api/chat';
  }
  ...
  @override
  Future<AIPreDiagnosis> analyzeSymptoms(Map<String, dynamic> symptoms) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(symptoms);
    final _options = _setStreamType<AIPreDiagnosis>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AIPreDiagnosis _value;
    try {
      _value = AIPreDiagnosis.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<SymptomAnalysis> getPreDiagnosis(
      Map<String, dynamic> questionnaire) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(questionnaire);
    final _options = _setStreamType<SymptomAnalysis>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SymptomAnalysis _value;
    try {
      _value = SymptomAnalysis.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<String>> getPostConsultationCare(int appointmentId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<String>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/post-consultation-care/${appointmentId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<List<String>> getAISuggestions(int patientId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<Map<String, String>> convertVoiceToText(
      Map<String, dynamic> audioData) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(audioData);
  ...
  @override
  Future<Map<String, dynamic>> convertTextToVoice(
      Map<String, String> textData) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
