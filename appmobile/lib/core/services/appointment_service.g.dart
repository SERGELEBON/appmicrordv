...
class _AppointmentService implements AppointmentService {
  _AppointmentService(
    ...
    baseUrl ??= 'http://10.0.2.2:8082/api/rdv';
  }
  ...
  Future<List<AppointmentSlot>> getDoctorAvailability(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<AppointmentSlot>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<AppointmentSlot> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              AppointmentSlot.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<Appointment> rescheduleAppointment(
    int id,
    Map<String, String> newDateTime,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(newDateTime);
    final _options = _setStreamType<Appointment>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
